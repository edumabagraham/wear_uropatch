...
class GenerateFeatures:
    ...
    def analyze_multi_axis_imu(self, df):
        ...
        signals = {
            'acc_x': df['acc_x'], 'acc_y': df['acc_y'], 'acc_z': df['acc_z'], 'acc_mag': df['acc_mag'],
            'gyr_x': df['gyr_x'], 'gyr_y': df['gyr_y'], 'gyr_z': df['gyr_z'], 'gyr_mag': df['gyr_mag']
        }
    ...
    def create_summary_table(self):
        ...
        measures = ['permutation_entropy', 'spectral_entropy', 'mean', 'std', 'range', 'rms',
                    'var', 'min', 'max', 'time_energy', 'spectral_centroid', 'spectral_spread',
