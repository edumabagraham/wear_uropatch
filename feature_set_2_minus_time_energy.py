...
# Sliding window feature extraction with center-point labeling
class GenerateFeatures:
    ...
    def analyze_signal(self, axis, labels, axis_name="axis"):
        """
        Perform sliding window entropy analysis on IMU signal with center-point labeling
        """
        ...
        for start_idx in range(0, n_samples - window_samples + 1, step_samples):
            ...
            # CENTER-POINT LABELING: Use the label at the center of the window
